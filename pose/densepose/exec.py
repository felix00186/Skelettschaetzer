...
os.makedirs("/app/cache2", exist_ok=True)
...
for file_name in mp4_files:
    ...
    args = [
        "python",
        "detectron2/projects/DensePose/apply_net.py",
        "show",
        "detectron2/projects/DensePose/configs/densepose_rcnn_R_50_FPN_DL_s1x.yaml",      # config
        "/app/model_final_0ed407.pkl",                   # model
        "cache/*.jpg",                              # input
